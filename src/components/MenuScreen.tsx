...
function MiniSheet({ className = '', style }: { className?: string; style?: CSSProperties }) {
  return (
    <div className={`pointer-events-none relative ${className}`} style={style} aria-hidden="true">
      <GridLines size={3} className="absolute inset-0 h-full w-full" />
...
export function MenuScreen({
  ...
  return (
    <div className="menu-scroll relative flex h-full w-full flex-col overflow-hidden py-3 sm:py-5">
      {/* логотип — у самого верха листа */}
      <header className="relative shrink-0 md:text-center">
